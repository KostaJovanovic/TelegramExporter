...
pub use lockdown::{ensure_data_dir, lockdown_error, system32, system_root};

// Test-only: the lockdown internals are exercised from this module's own
// tests, which is where the ACL cases were written.
#[cfg(test)]
use lockdown::{grantee, restrict_to_current_user, set_lockdown_error};
